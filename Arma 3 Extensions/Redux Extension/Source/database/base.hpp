...
public:
	...
	virtual std::string querydbversion() {};
	virtual std::vector<std::vector<std::string> > verbosetest(std::string query) {};

	virtual std::string loadPlayer(std::string nickname, std::string steamid) {};
	virtual std::string loadAvChars(std::string playeruuid) {};
	virtual std::string linkChars(std::string playeruuid, std::string variabuuid) {};
	virtual std::string loadChar(std::string playeruuid) {};
	...
	virtual std::string loadObject(std::string objectuuid) {};
	...
	virtual std::vector<std::vector<std::string> > dumpObjects() {};
};
