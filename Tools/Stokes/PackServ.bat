...
"%mikeroTools%\MakePbo.exe" -@=ObjectMovement -p -x "thumbs.db,*.txt,*.h,*.dep,*.cpp,*.bak,*.bat,*.png,*.log,*.pew,*.tga" -z "*.wss,*.ogg,*.jpg,*.wav,*.fsm,*.pac,*.paa" "%modSource%\ObjectMovement" "%deploy%\ObjectMovement.pbo"
exit /b