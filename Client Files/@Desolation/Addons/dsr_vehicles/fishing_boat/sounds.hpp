	...
	insideSoundCoef = 1;
	soundEngineOnInt[] = {"\dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-start-02", db-5, 1.0};
	soundEngineOnExt[] = {"\dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-start-02", db-5, 1.0, 300};
	soundEngineOffInt[] = {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-stop-02", db-5, 1.0};
	soundEngineOffExt[] = {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-stop-02", db-5, 1.0, 300};
	...
	/*  EXTERNAL SOUNDS	SPEEDBOAT  */
		class IdleOut
		{
			sound[] = {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-idle-03", db-7, 1.0, 300};
		...
		class Engine //LOW
		{
		  sound[] =  {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-low-05", db-4, 1.0, 350};
		...
		class EngineMidOut
		{
			sound[] = {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-low-05", db-2, 1.0, 380};
		...
		class EngineMaxOut2
		{
			sound[] = {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-hi-04", db-1, 1.0, 440};
		...
		class EngineMaxOut3
		{
			sound[] = {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-hi-04", db0, 1.0, 500};
		...
		class EngineMaxOut4
		{
			sound[] = {"dsr_vehicles\fishing_boat\data\sounds\ext-slowboat-engine-hi-04", db2, 1.0, 550};
