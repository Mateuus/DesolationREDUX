...
soundGetIn[]={"dsr_vehicles\SUV\data\sounds\SUV_ext_door",db-5,1};
soundGetOut[]={"dsr_vehicles\SUV\data\sounds\SUV_ext_door",db-5,1, 40};
soundDammage[]={"", db-5, 1};
soundEngineOnInt[] = {"dsr_vehicles\SUV\data\sounds\SUV_int_start_2", db-8, 1.0};
soundEngineOnExt[] = {"dsr_vehicles\SUV\data\sounds\SUV_ext_stop", db-7, 1.0, 200};
soundEngineOffInt[] = {"dsr_vehicles\SUV\data\sounds\SUV_int_stop", db-8, 1.0};
soundEngineOffExt[] = {"dsr_vehicles\SUV\data\sounds\SUV_ext_stop", db-7, 1.0, 200};
...
class Sounds
{
	...
	class Idle_ext
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_ext_idle", db-13,	1, 150};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*camPos*VOLUME_IDLE;
	};
	class Engine
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_ext_low",	db-11,1, 200};
		frequency	=	0.8	+	HZ_RPM1*0.2;
		volume = engineOn*camPos*VOLUME_RPM1;
	};
	class Engine1_ext
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_ext_low",	db-9,1, 240};
		frequency	=	0.8	+	HZ_RPM2*0.2;
		volume = engineOn*camPos*VOLUME_RPM2;
	};
	class Engine2_ext
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_ext_mid",	db-8,1, 280};
		frequency	=	0.8	+	HZ_RPM3*0.2;
		volume = engineOn*camPos*VOLUME_RPM3;
	};
	class Engine3_ext
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_ext_mid",	db-7,1, 320};
		frequency	=	0.8	+	HZ_RPM4*0.2;
		volume = engineOn*camPos*VOLUME_RPM4;
	};
	class Engine4_ext
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_ext_high",	db-6,1, 360};
		frequency	=	0.8	+	HZ_RPM5*0.2;
		volume = engineOn*camPos*VOLUME_RPM5;
	};
	class Engine5_ext
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_ext_high_1",	db-5,1, 420};
	...
	class Idle_int
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_int_idle_x", db-15,	1};
		frequency	=	0.9	+	HZ_IDLE*0.2;
		volume = engineOn*(1-camPos)*VOLUME_IDLE;
	};
	class Engine_int
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_int_accelerate_3_x",	db-14,1 };
		frequency	=	0.8	+	HZ_RPM1*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM1;
	};
	class Engine1_int
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_int_low_x",	db-12,1 };
		frequency	=	0.8	+	HZ_RPM2*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM2;
	};
	class Engine2_int
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_int_low_engine",	db-11,1 };
		frequency	=	0.8	+	HZ_RPM3*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM3;
	};
	class Engine3_int
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_int_mid_x",	db-10,1 };
		frequency	=	0.8	+	HZ_RPM4*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM4;
	};
	class Engine4_int
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_int_high_x",	db-9,1 };
		frequency	=	0.8	+	HZ_RPM5*0.2;
		volume = engineOn*(1-camPos)*VOLUME_RPM5;
	};
	class Engine5_int
	{
		sound[]	=	{"dsr_vehicles\SUV\data\sounds\SUV_int_high_x",	db-6,1 };
		frequency	=	0.95	+	HZ_RPM6*0.15;
