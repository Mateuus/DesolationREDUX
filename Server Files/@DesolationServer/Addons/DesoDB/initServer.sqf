...
if !(isNil Global_Var_WORLD_UUID) then {
    PREFIX_fnc_Send_Request = compile preprocessFileLineNumbers "path\to\sendRequest.sqf;
    PREFIX_fnc_spawnCharacter = compile preprocessFileLineNumbers "path\to\spawnCharacter.sqf;
    ...
    ...
    [_request] call PREFIX_fnc_Send_Request;
} else {
     // log error
