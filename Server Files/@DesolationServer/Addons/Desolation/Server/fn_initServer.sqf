...
//addMPEventHandler ["onPlayerConnected", { [_uid, _name] call ExileServer_system_network_event_onPlayerConnected; }] call BIS_fnc_addStackedEventHandler;
//addMPEventHandler ["onPlayerDisconnected", { [_uid, _name] call ExileServer_system_network_event_onPlayerDisconnected; }] call BIS_fnc_addStackedEventHandler;
//onPlayerConnected {[_uid, _name] call DS_fnc_event_onPlayerConnected};
onPlayerDisconnected {[_uid, _name] call DS_fnc_event_onPlayerDisconnected};
addMissionEventHandler ["HandleDisconnect", { _this call DS_fnc_onHandleDisconnect; }];



// start Vehicle Spawns
[] spawn {
	_vehCount = [] call DS_fnc_spawnDatabaseVehicles;// spawn all claimed vehicles
	_randomSpawnCount = 1000 - _vehCount;
