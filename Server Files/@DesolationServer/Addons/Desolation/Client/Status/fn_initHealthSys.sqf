...
DS_var_lastAte = player getVariable ["SVAR_DS_var_lastAte",0];
DS_var_lastDrank = player getVariable ["SVAR_DS_var_lastDrank",0];
DS_var_lastKnockout = 0;
DS_var_InfectionDOT = player getVariable ["SVAR_DS_var_InfectionDOT",0];
DS_var_Immune = false;
DS_var_lastImmune = player getVariable ["SVAR_DS_var_lastImmune",0];